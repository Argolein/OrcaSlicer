...
std::string GCode::travel_to(const Point& point, ExtrusionRole role, std::string comment, double z/* = DBL_MAX*/)
{
    ...
    if (this->on_first_layer()) {
        const double initial_layer_travel_acceleration = m_config.get_abs_value_at("initial_layer_travel_acceleration", cur_extruder_index());
        const double initial_layer_travel_jerk         = m_config.get_abs_value_at("initial_layer_travel_jerk", cur_extruder_index());
